...
// ../../node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.22.4/node_modules/zod-validation-error/dist/esm/utils/joinPath.js
...
// ../../node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.22.4/node_modules/zod-validation-error/dist/esm/utils/NonEmptyArray.js
function isNonEmptyArray(value) {
  return value.length !== 0;
}

// ../../node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.22.4/node_modules/zod-validation-error/dist/esm/ValidationError.js
...
// ../../node_modules/.pnpm/@latticexyz+config@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/config/dist/chunk-NOTUCTDJ.js
var a = Object.defineProperty;
var d = (r4, e2, o3) => e2 in r4 ? a(r4, e2, { enumerable: true, configurable: true, writable: true, value: o3 }) : r4[e2] = o3;
var p = (r4, e2, o3) => (d(r4, typeof e2 != "symbol" ? e2 + "" : e2, o3), o3);
var t = class extends Error {
  constructor() {
    super(...arguments);
    __publicField(this, "name", "MUDContextAlreadyCreatedError");
    __publicField(this, "message", "MUD context was already created");
  }
};
var s = class extends Error {
  constructor() {
    super(...arguments);
    __publicField(this, "name", "MUDContextNotCreatedError");
    __publicField(this, "message", "MUD context has not been created");
  }
};
function f(r4, e2) {
  return fromZodError(r4, { prefix: e2, prefixSeparator: `
- `, issueSeparator: `
- ` });
}

// ../../node_modules/.pnpm/@latticexyz+common@2.0.0-next.14_typescript@5.1.6_zod@3.22.4/node_modules/@latticexyz/common/dist/chunk-UPQEB2HW.js
var r = class extends Error {
  constructor() {
    super(...arguments);
    __publicField(this, "name", "MUDError");
  }
};

// ../../node_modules/.pnpm/@latticexyz+config@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/config/dist/chunk-YRED5UZY.js
var z2 = 16;
var g = 14;
function d2(e2, t3) {
  /^\w+$/.test(e2) || t3.addIssue({ code: ZodIssueCode.custom, message: "Name must contain only alphanumeric & underscore characters" });
}
function x(e2, t3) {
  d2(e2, t3), /^[A-Z]/.test(e2) || t3.addIssue({ code: ZodIssueCode.custom, message: "Name must start with a capital letter" });
}
function C(e2, t3) {
  d2(e2, t3), /^[a-z]/.test(e2) || t3.addIssue({ code: ZodIssueCode.custom, message: "Name must start with a lowercase letter" });
}
function h(e2, t3) {
  e2.length === 0 && t3.addIssue({ code: ZodIssueCode.custom, message: "Enum must not be empty" }), e2.length >= 256 && t3.addIssue({ code: ZodIssueCode.custom, message: "Length of enum must be < 256" });
  let o3 = M(e2);
...
function c(e2, t3) {
  return (o3, n4) => {
    if (o3 === "") {
      e2 && n4.addIssue({ code: ZodIssueCode.custom, message: "Route must not be empty" });
      return;
    }
    ...
    let a4 = o3.split("/");
    t3 && a4.length > 2 && n4.addIssue({ code: ZodIssueCode.custom, message: 'Route must only have one level (e.g. "/foo")' });
    for (let u4 = 1; u4 < a4.length; u4++)
      a4[u4] === "" && n4.addIssue({ code: ZodIssueCode.custom, message: 'Route must not contain empty route fragments (e.g. "//")' }), /^\w+$/.test(a4[u4]) || n4.addIssue({ code: ZodIssueCode.custom, message: "Route must contain only alphanumeric & underscore characters" });
  };
}
var R = c(true, false);
var y = c(false, false);
var b = c(true, true);
function D(e2, t3) {
  isAddress(e2) || t3.addIssue({ code: ZodIssueCode.custom, message: "Address must be a valid Ethereum address" });
}
function M(e2) {
...
function E(e2, t3) {
  e2.length > g && t3.addIssue({ code: ZodIssueCode.custom, message: `Namespace must be <= ${g} characters` }), /^\w*$/.test(e2) || t3.addIssue({ code: ZodIssueCode.custom, message: "Selector must contain only alphanumeric & underscore characters" });
}
function S(e2) {
  let t3 = e2.match(/^(\w+)\[(\d+)\]$/);
  return t3 ? { elementType: t3[1], staticLength: Number.parseInt(t3[2]) } : null;
}
var v = z.string().superRefine(x);
var B = z.string().superRefine(C);
var G = z.string().superRefine(d2);
var O2 = z.string().superRefine(E);
var V = z.array(v).superRefine(h);
var j = z.string().superRefine(R);
var k = z.string().superRefine(b);
var H = z.string().superRefine(y);
var P = z.string().superRefine(D);
var l = class {
  constructor() {
    __publicField(this, "configExtenders", []);
  }
  static isCreated() {
...
var s3 = Object.values(Y);
var _ = Object.fromEntries(Object.entries(Y).map(([R3, A]) => [A, parseInt(R3)]));
function n(R3) {
  let A = R3.valueOf();
  return A < 32 ? A + 1 : A < 64 ? A + 1 - 32 : A < 96 ? A + 1 - 64 : R3 == 96 ? 1 : R3 == 97 ? 20 : 0;
}
var U = s3.filter((R3) => n(_[R3]) > 0);

// ../../node_modules/.pnpm/@latticexyz+schema-type@2.0.0-next.14_typescript@5.1.6_zod@3.22.4/node_modules/@latticexyz/schema-type/dist/typescript/index.js
var n3 = /\[\]$/;
function b2(t3) {
  return n3.test(t3);
}
function r2(t3) {
  return t3.replace(n3, "");
}
...
var u2 = z.string();
var q2 = z.string();
var B2 = z.record(V2, q2).default(c3.keySchema);
var h2 = z.record(_2, u2).refine((e2) => Object.keys(e2).length > 0, "Table schema may not be empty");
var M2 = u2.transform((e2) => h2.parse({ value: e2 }));
var w2 = h2.or(M2);
var x3 = z.object({ directory: z.string().default(c3.directory), name: G.optional(), tableIdArgument: z.boolean().default(c3.tableIdArgument), storeArgument: z.boolean().default(c3.storeArgument), dataStruct: z.boolean().optional(), keySchema: B2, valueSchema: w2, offchainOnly: z.boolean().default(c3.offchainOnly) }).transform((e2) => (Object.keys(e2.valueSchema).length === 1 ? e2.dataStruct ?? (e2.dataStruct = false) : e2.dataStruct ?? (e2.dataStruct = true), e2));
var H2 = u2.transform((e2) => x3.parse({ valueSchema: { value: e2 } }));
var G2 = x3.or(H2);
var X = z.record(L, G2).transform((e2) => {
  for (let n4 of Object.keys(e2)) {
    let s5 = e2[n4];
    s5.name = n4.slice(0, z2), e2[n4] = s5;
  }
  return e2;
});
var Z2 = z.object({ enums: z.record(P4, V).default(p2.enums) });
var J = z.object({ filePath: z.string(), internalType: z.enum(i2) });
var Q = z.object({ userTypes: z.record($, J).default(p2.userTypes) });
var C2 = z.object({ namespace: O2.default(p2.namespace), storeImportPath: z.string().default(l2.storeImportPath), tables: X, userTypesFilename: z.string().default(l2.userTypesFilename), codegenDirectory: z.string().default(l2.codegenDirectory), codegenIndexFilename: z.string().default(l2.codegenIndexFilename) }).merge(Z2).merge(Q);
var fe = C2.superRefine(E2);
var Ue = C2.catchall(z.any()).superRefine(E2);
function E2(e2, n4) {
  for (let i4 of Object.values(e2.tables)) {
    let y4 = Object.keys(i4.keySchema), A = Object.keys(i4.valueSchema), f3 = M([...y4, ...A]);
    f3.length > 0 && n4.addIssue({ code: ZodIssueCode.custom, message: `Field and key names within one table must be unique: ${f3.join(", ")}` });
  }
  let s5 = Object.keys(e2.tables), t3 = [...Object.keys(e2.enums), ...Object.keys(e2.userTypes)], a4 = t3, o3 = [...s5, ...a4], m4 = M(o3);
  m4.length > 0 && n4.addIssue({ code: ZodIssueCode.custom, message: `Table library names, enum names, user type names must be globally unique: ${m4.join(", ")}` });
  let v2 = Object.values(e2.tables).map(({ name: i4 }) => i4), S3 = M(v2);
  S3.length > 0 && n4.addIssue({ code: ZodIssueCode.custom, message: `Table names must be unique: ${S3.join(", ")}` });
  for (let i4 of Object.values(e2.tables)) {
    for (let y4 of Object.values(i4.keySchema))
      F(t3, y4, n4);
    for (let y4 of Object.values(i4.valueSchema))
      W(a4, t3, y4, n4);
  }
}
function W(e2, n4, s5, t3) {
  if (!s3.includes(s5) && !e2.includes(s5)) {
    let a4 = S(s5);
    a4 ? Y2(n4, a4.elementType, a4.staticLength, t3) : t3.addIssue({ code: ZodIssueCode.custom, message: `${s5} is not a valid abi type, and is not defined in userTypes` });
  }
}
function F(e2, n4, s5) {
  !U.includes(n4) && !e2.includes(n4) && s5.addIssue({ code: ZodIssueCode.custom, message: `${n4} is not a static type` });
}
function Y2(e2, n4, s5, t3) {
  F(e2, n4, t3), s5 === 0 ? t3.addIssue({ code: ZodIssueCode.custom, message: "Static array length must not be 0" }) : s5 >= 2 ** 16 && t3.addIssue({ code: ZodIssueCode.custom, message: "Static array length must be less than 2**16" });
}
function Ce(e2) {
  let n4 = {};
  for (let s5 of Object.keys(e2.tables))
    n4[s5] = se(e2.tables[s5], e2.userTypes, Object.keys(e2.enums), e2.namespace, s5);
  return { tables: n4 };
}
function se(e2, n4, s5, t3, a4) {
  let { keySchema: o3, valueSchema: m4 } = e2;
  return { keySchema: te2(o3, n4, s5), valueSchema: re(m4, n4, s5), namespace: t3, name: a4, tableId: O({ type: e2.offchainOnly ? "offchainTable" : "table", namespace: t3, name: a4 }) };
}
function te2(e2, n4, s5) {
  let t3 = e2 == null ? { key: "bytes32" } : typeof e2 == "string" ? { key: e2 } : e2;
  return N2(t3, n4, s5);
}
function re(e2, n4, s5) {
  return N2(typeof e2 == "string" ? { value: e2 } : e2, n4, s5);
}
function N2(e2, n4, s5) {
  return S2(e2, (t3, a4) => {
    let o3 = n4 && t3 in n4, m4 = s5.includes(t3);
    return { type: o3 ? n4[t3].internalType : m4 ? "uint8" : t3, internalType: t3 };
  });
}

// ../../node_modules/.pnpm/@latticexyz+config@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/config/dist/register/index.js
i.isCreated() || i.createContext();

// ../../node_modules/.pnpm/@latticexyz+store@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/store/dist/chunk-JTS5DV3J.js
K((r4) => {
  try {
    return Ue.parse(r4);
  } catch (e2) {
    throw e2 instanceof ZodError ? f(e2, "StoreConfig Validation Error") : e2;
  }
});
function m2(r4) {
  return q(r4);
...
// ../../node_modules/.pnpm/@latticexyz+world@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/world/dist/chunk-UYSOB7U2.js
var o2 = { registerFunctionSelector: true, openAccess: true, accessList: [] };
var t2 = { worldContractName: void 0, worldInterfaceName: "IWorld", systems: {}, excludeSystems: [], postDeployScript: "PostDeploy", deploysDirectory: "./deploys", worldsFile: "./worlds.json", worldgenDirectory: "world", worldImportPath: "@latticexyz/world/src/", modules: [] };
var r3 = v;
var a3 = v;
var i3 = z.array(r3.or(P)).default(o2.accessList);
var d3 = z.intersection(z.object({ name: G.optional(), registerFunctionSelectors: z.boolean().default(o2.registerFunctionSelector) }), z.discriminatedUnion("openAccess", [z.object({ openAccess: z.literal(true).default(o2.openAccess) }), z.object({ openAccess: z.literal(false), accessList: i3 })]));
var u3 = z.object({ value: z.union([z.string(), z.number(), z.instanceof(Uint8Array)]), type: z.string() });
var m3 = z.object({ type: z.nativeEnum(N), input: z.string() });
var p3 = z.object({ name: a3, root: z.boolean().default(false), args: z.array(z.union([u3, m3])).default([]) });
var y3 = z.object({ worldContractName: z.string().optional(), worldInterfaceName: z.string().default(t2.worldInterfaceName), systems: z.record(r3, d3).default(t2.systems), excludeSystems: z.array(r3).default(t2.excludeSystems), postDeployScript: z.string().default(t2.postDeployScript), deploysDirectory: z.string().default(t2.deploysDirectory), worldsFile: z.string().default(t2.worldsFile), worldgenDirectory: z.string().default(t2.worldgenDirectory), worldImportPath: z.string().default(t2.worldImportPath), modules: z.array(p3).default(t2.modules) });
var w3 = y3.catchall(z.any());

// ../../node_modules/.pnpm/@latticexyz+world@2.0.0-next.14_typescript@5.1.6/node_modules/@latticexyz/world/dist/chunk-QVSE2CLC.js
K((r4) => {
  try {
    return w3.parse(r4);
  } catch (o3) {
    throw o3 instanceof ZodError ? f(o3, "WorldConfig Validation Error") : o3;
  }
});
...
//# sourceMappingURL=chunk-KPE323GY.js.map
