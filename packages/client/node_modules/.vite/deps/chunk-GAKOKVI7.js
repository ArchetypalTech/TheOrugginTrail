...
// ../../node_modules/.pnpm/@latticexyz+utils@2.0.0-next.14/node_modules/@latticexyz/utils/dist/index.js
...
// ../../node_modules/.pnpm/@latticexyz+recs@2.0.0-next.14_typescript@5.1.6_zod@3.22.4/node_modules/@latticexyz/recs/dist/chunk-YDQFEK6R.js
var P = ((o) => (o[o.Boolean = 0] = "Boolean", o[o.Number = 1] = "Number", o[o.OptionalNumber = 2] = "OptionalNumber", o[o.BigInt = 3] = "BigInt", o[o.OptionalBigInt = 4] = "OptionalBigInt", o[o.String = 5] = "String", o[o.OptionalString = 6] = "OptionalString", o[o.NumberArray = 7] = "NumberArray", o[o.OptionalNumberArray = 8] = "OptionalNumberArray", o[o.BigIntArray = 9] = "BigIntArray", o[o.OptionalBigIntArray = 10] = "OptionalBigIntArray", o[o.StringArray = 11] = "StringArray", o[o.OptionalStringArray = 12] = "OptionalStringArray", o[o.Entity = 13] = "Entity", o[o.OptionalEntity = 14] = "OptionalEntity", o[o.EntityArray = 15] = "EntityArray", o[o.OptionalEntityArray = 16] = "OptionalEntityArray", o[o.T = 17] = "T", o[o.OptionalT = 18] = "OptionalT", o))(P || {});
...
function M(e) {
  ...
  let m = e.update$.subscribe(({ entity: l, value: u }) => {
    d(p(l), u[1]), i(p(l), u[0]);
  });
  return e.world.registerDisposer(() => m == null ? void 0 : m.unsubscribe()), { ...e, getEntitiesWithValue: n };
}
function X(e, t) {
...
function ie(e, t, n) {
  ...
  let r = (n == null ? void 0 : n.id) ?? ue(), i = $r(t, () => /* @__PURE__ */ new Map()), d = new Subject(), m = n == null ? void 0 : n.metadata, u = { values: i, schema: t, id: r, update$: d, metadata: m, entities: () => I(Object.values(i)[0].keys(), v), world: e };
  return (n == null ? void 0 : n.indexed) && (u = M(u)), e.registerComponent(u), u;
}
function E(e, t, n, r = {}) {
  var _a;
  let i = p(t), d = g(e, t);
  for (let [m, l] of Object.entries(n))
    e.values[m] ? e.values[m].set(i, l) : ((_a = e.metadata) == null ? void 0 : _a.tableId) && /^\d+$/.test(m) || console.warn("Component definition for", b(e), "is missing key", m, ", ignoring value", l, "for entity", t, ". Existing keys: ", Object.keys(e.values));
  r.skipUpdateStream || e.update$.next({ entity: t, value: [n, d], component: e });
}
function se(e, t, n, r, i = {}) {
  let d = g(e, t);
  if (d === void 0) {
    if (r === void 0)
      throw new Error(`Can't update component ${b(e)} without a current value or initial value`);
    E(e, t, { ...r, ...n }, i);
  } else
    E(e, t, { ...d, ...n }, i);
}
function ue2(e, t, n = {}) {
  let r = p(t), i = g(e, t);
  for (let d of Object.keys(e.values))
    e.values[d].delete(r);
...
function g(e, t) {
  ...
  for (let d of i) {
    let m = e.values[d].get(r);
    if (m === void 0 && !w.includes(e.schema[d]))
      return;
    n[d] = m;
  }
  return n;
...
function de(e, t) {
  let n = g(e, t);
  if (!n)
    throw new Error(`No value for component ${b(e)} on entity ${t}`);
  return n;
}
function K(e, t) {
  if (!e && !t)
...
function ce(e, t) {
  if (I2(e) && T(e, t))
    return e.getEntitiesWithValue(t);
...
function Se(e) {
  ...
  for (let s of Object.keys(e.values))
    x2[s] = new Proxy(e.values[s], u(s));
  let f2 = x2, y2 = new Proxy(e, { get(s, a) {
    return a === "addOverride" ? d : a === "removeOverride" ? m : a === "values" ? f2 : a === "update$" ? i : a === "entities" ? () => (/* @__PURE__ */ new Set([...I(r.keys(), v), ...s.entities()])).values() : Reflect.get(s, a);
  }, has(s, a) {
  ...
  return e.update$.pipe(filter((s) => !r.get(p(s.entity))), map((s) => ({ ...s, component: y2 }))).subscribe(i), y2;
}
function A(e, t) {
...
function pe(e, t) {
  let { world: n, update$: r, values: i } = e, d = A(e, t), m = 0, l = Date.now(), u = localStorage.getItem(d);
  if (u) {
  ...
  let x2 = r.subscribe(() => {
    ...
    localStorage.setItem(d, f2), m > 200 && console.warn("Component", b(e), "was locally cached", m, "times since", new Date(l).toLocaleTimeString(), "- the local cache is in an alpha state and should not be used with components that update frequently yet");
  });
...
// ../../node_modules/.pnpm/@latticexyz+recs@2.0.0-next.14_typescript@5.1.6_zod@3.22.4/node_modules/@latticexyz/recs/dist/index.js
...
function c(e, t) {
  if (t.type === 0)
    return le(t.component, e);
  if (t.type === 1)
    return K(t.value, g(t.component, e));
  if (t.type === 2)
    return !le(t.component, e);
  if (t.type === 3)
    return !K(t.value, g(t.component, e));
    ...
    if (J(o))
      ...
      for (let p2 of [...n]) {
        ...
        if (r && r.depth > 0 && !U2(m, o) && (m = I3(p2, o, r) ?? m), m || n.delete(p2), a && a.depth > 0) {
          ...
          for (let i of d)
            (c(i, o) || r && r.depth > 0 && I3(i, o, r)) && n.add(i);
        }
      }
    else {
      if (P2(o))
        throw new Error("First EntityQueryFragment must be Has or HasValue");
      if (n = o.type === 0 ? /* @__PURE__ */ new Set([...V(o.component)]) : ce(o.component, o.value), a && a.depth > 0)
        for (let p2 of [...n])
          for (let m of Q(p2, a.component, a.depth))
            n.add(m);
    }
  }
...
function f(e, t) {
  let n = (t == null ? void 0 : t.runOnInit) || (t == null ? void 0 : t.initialSet) ? A2(e, t.initialSet) : /* @__PURE__ */ new Set(), r = observable(n), a = from(r).pipe(Y(e[0].component)), y2 = e.findIndex((p2) => [5, 4].includes(p2.type)) !== -1, o = merge(...e.map((p2) => p2.component.update$)).pipe(y2 ? concatMap((p2) => {
    ...
    for (let i of r)
      m.has(i) || (r.delete(i), d.push({ entity: i, type: 1, component: p2.component, value: [void 0, void 0] }));
    for (let i of m)
      r.has(i) ? d.push({ entity: i, type: 2, component: p2.component, value: [g(p2.component, i), void 0] }) : (r.add(i), d.push({ entity: i, type: 0, component: p2.component, value: [g(p2.component, i), void 0] }));
    return of(...d);
  }) : map((p2) => {
    if (r.has(p2.entity))
      return e.filter((u) => u.component.id === p2.component.id).every((u) => c(p2.entity, u)) ? { ...p2, type: 2 } : (r.delete(p2.entity), { ...p2, type: 1 });
    if (e.every((d) => c(p2.entity, d)))
      return r.add(p2.entity), { ...p2, type: 0 };
  }), ur());
...
function yt(e, t, n, r = { runOnInit: true }) {
  x(e, k2(t, r), n);
}
function _14(e, t, n, r = { runOnInit: true }) {
  x(e, f(t, r).update$, n);
}
function ut(e, t, n, r = { runOnInit: true }) {
  let a = (r == null ? void 0 : r.runOnInit) ? from(V(t)).pipe(Y(t)) : EMPTY;
  x(e, concat(a, t.update$), n);
}
function mt(e, t, n, r, a = { update: false, runOnInit: true }) {
  _14(e, t, ({ entity: y2, type: o }) => {
    o === 0 && E(n(y2), y2, r(y2)), o === 1 && ue2(n(y2), y2), (a == null ? void 0 : a.update) && o === 2 && E(n(y2), y2, r(y2));
  }, a);
}
function ft() {
  ...
  function o(i) {
    for (let [, u] of n.filter((T2) => !i || T2[0] === i))
      u();
...
function Tt(e, t) {
  return e.components.filter((n) => le(n, t));
}
...
@latticexyz/utils/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GAKOKVI7.js.map
