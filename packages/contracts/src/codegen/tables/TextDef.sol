...
library TextDef {
   ...
   * @notice Get description.
   */
  function get(bytes32 key) internal view returns (string memory description) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get description.
   */
  function _get(bytes32 key) internal view returns (string memory description) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set description.
   */
  function set(bytes32 key, string memory description) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set description.
   */
  function _set(bytes32 key, string memory description) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function encode(string memory description) internal pure returns (bytes memory, PackedCounter, bytes memory) {
