...
export type UnaryClientMethod<RequestIn, ResponseOut, CallOptionsExt = {}> = (request: RequestIn, options?: CallOptions & CallOptionsExt) => Promise<ResponseOut>;
export type ServerStreamingClientMethod<RequestIn, ResponseOut, CallOptionsExt = {}> = (request: RequestIn, options?: CallOptions & CallOptionsExt) => AsyncIterable<ResponseOut>;
export type ClientStreamingClientMethod<RequestIn, ResponseOut, CallOptionsExt = {}> = (request: AsyncIterable<RequestIn>, options?: CallOptions & CallOptionsExt) => Promise<ResponseOut>;
export type BidiStreamingClientMethod<RequestIn, ResponseOut, CallOptionsExt = {}> = (request: AsyncIterable<RequestIn>, options?: CallOptions & CallOptionsExt) => AsyncIterable<ResponseOut>;
