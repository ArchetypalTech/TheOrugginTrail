import type { ChangeColumnTableName, Dialect } from '../column-builder.js';
import type { AnyColumn, Column, GetColumnData, UpdateColConfig } from '../column.js';
...
import type { ColumnsSelection, View } from '../view.js';
...
export type ApplyNullabilityToColumn<TColumn extends Column, TNullability extends JoinNullability> = TNullability extends 'not-null' ? TColumn : Column<UpdateColConfig<TColumn['_'], {
